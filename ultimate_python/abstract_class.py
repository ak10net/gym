"""
Abstract class is an extension of a basic class. Like a basic class,
an abstract class has methods and state. Unlike a basic class, 
it inherits the `ABC` class and has at least one `abstractmethod`.
That means we ccnot create an instace directly from its constructor. In this
module, we will create an abstract class and two concrete classes. 
"""
...
class Engineer(Employee):
	...
	The engineer class is concrete becasue it implements every
	...
	is something that a manger prefers not to do"""
	...
	def do_refactor(self):
		"""Do the hard work of refactoring code, unlike manager"""
...
def main():
	...
	# Engineer can work, relax and refactor
